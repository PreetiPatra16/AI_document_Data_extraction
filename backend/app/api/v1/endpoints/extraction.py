...
@router.post("/{document_id}", response_model=ExtractionTriggerResponse, status_code=status.HTTP_202_ACCEPTED)
async def trigger_extraction(document_id: str, storage: StorageService = Depends(get_storage_service)):
